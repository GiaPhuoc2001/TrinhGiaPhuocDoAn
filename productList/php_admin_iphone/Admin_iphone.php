...
<?php
    ...
    $sql = "SELECT * FROM `db_sanpham_iphone`";
...
<div id="danhsach">
    <div class="bt">
        <button>
            <a href="./addsp_iphone.php">Thêm iPhone</a>
        </button>
    </div>
    <div class="headline">
                ...
                <div class="product-item">
                    <div class="product-top">
                        <a href="" class="product-thumb">
                            <img src="" alt=""><img style="" src='./IPHONE_img/<?= $row['imgURL'] ?>' alt=""></a>
                        ...
                        <div class="product-info">
                            ...
                            <div class="product-price"><a href="updatesp_iphone.php?id=<?= $row['id']?>">Cập Nhập</a>
                <a class="product-price" onclick="return xoasanpham()" href="delete_iphone.php?id=<?= $row['id']?>"><i class="ti-trash"></i></a></div>
            </li>
            </ul>
