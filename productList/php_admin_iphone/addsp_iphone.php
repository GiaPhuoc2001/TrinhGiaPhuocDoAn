...
<head>
    ...
    <title>Thêm Sản Phẩm iPhone</title>
...
<body>
    ...
    $target_file = $target_dir . $hinhanh;
        ...
        if (isset($hinhanh) && isset($dungluong) && isset($ten) && isset($gia)) {
            ...
            $sql = "INSERT INTO `db_sanpham_iphone` (`id`, `imgURL`, `dungluong`, `tensp`, `gia`) VALUES (NULL, '$hinhanh', '$dungluong', '$ten', '$gia');";
    ...
    <div class="wrapper"></div>
        <form action="" method="POST" enctype="multipart/form-data">
            ...
            <a class="return" href="./Admin_iphone.php">Quay về</a>
        </form>
    </div>
<style>
    form {
