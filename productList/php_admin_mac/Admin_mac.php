...
<?php
    ...
    $sql = "SELECT * FROM `db_sanpham_mac`";
...
<div id="header">
        ...
        <ul id="nav">
            ...
            <li><a class="menubar" href="/PPT-SHOPPING/productList/php_admin_ipad/Admin_mac.php">Mac</a></li>
...
<div id="danhsach">
    <div class="bt">
        <button>
            <a href="./addsp_mac.php">Thêm MAC</a>
        </button>
    </div>
    <div class="headline">
            <h3 class="title-h3">MAC</h3>
        </div>
    <div id="wrapper">
    <?php 
                ...
                <div class="product-item">
                    <div class="product-top">
                        <a href="" class="product-thumb">
                            <img src="" alt=""><img style="" src='./MAC_img/<?= $row['mac_URL'] ?>' alt=""></a>
                        ...
                        <div class="product-info">
                            ...
                            <div class="product-price"><a href="updatesp_mac.php?id=<?= $row['id']?>">Cập Nhập</a>
                <a class="product-price" onclick="return xoasanpham()" href="delete_mac.php?id=<?= $row['id']?>"><i class="ti-trash"></i></a></div>
            </li>
    </ul>
